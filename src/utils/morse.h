...
/**
 * morse_ht_freq_to_s1g_chan () - Maps HT frequency to S1G channel
 *
 * @ht_freq: HT frequency in MHz
 * @country: Country code
 *
 * Returns: S1G Channel number on success or -1 if the frequency cannot be mapped for
 * given country code
 */
